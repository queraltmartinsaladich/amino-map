...
function App() {
  ...
  return (
    <>
    <div id="mobile-overlay" className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#0F172A] p-10 text-center md:hidden">
    ...
    <div id="main-content" className="bg-[#FFFFFF] ml-[40px] mr-[40px] mt-[20px] mb-[30px] pl-[10px] pr-[10px] text-[#0F172A]"> 
      ...
      <div className="mx-auto"> 
        ...
        <header id="header" className="flex flex-col items-center w-full py-[8px]">
          <div className="flex items-center justify-between w-full overflow-hidden">
            ...
            <div className="mt-[-30px] ml-[-10px] w-1/2 max-w-2xl flex-shrink min-w-[50px] scale-x-[-1]">
              <svg 
                viewBox="0 0 240 40" 
                className="w-full h-auto" 
                fill="none" 
              ...
              <div key={selectedVariant.variant_id} className="mt-[-1px] sticky bg-[#FFFFFF] animate-in fade-in duration-300">
                ...
                <div className="px-[10px] py-[10px] border-2 border-[#F1F5F9] flex flex-col gap-[2px]">
                  ...
                  <DataPoint 
                    ...
                    color={selectedVariant.am_pathogenicity > 0.564 ? "text-[#df3721ff]" : selectedVariant.am_pathogenicity < 0.34 ? "text-[#2a9723ff]" : "text-[#d8a122ff]"}
                  />
                  {/* Stability */}
                  <DataPoint 
                    className="mt-[-30px]"
                    ...
                    color={selectedVariant.pred_ddg > 0.0 ? "text-[#df3721ff]" : "text-[#2a9723ff]"}
                  />
                </div>
